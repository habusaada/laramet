                ...
                <div class="card">
                    ...
                    <div class="px-10 pb-10 card-body px-lg-20 pt-17">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table align-middle table-striped gy-7">
                                ...
                                <thead class="align-middle">
                                    <tr id="kt_pricing">
                                        <th class="text-start ps-9 min-w-200px">Role Permession</th>
                                    </tr>
                                </thead>
                                <!--end::Table head-->
                                <!--begin::Table body-->
                        ...
                        <div class="flex-wrap d-flex flex-stack mt-lg-20 pt-13">
                            ...
                            <div class="my-1 me-5">
                                <!-- begin::Download-->
                                <a href="{{ route('permission.index') }}" class="my-1 btn btn-light">User Role Permissions List</a>
                                <!-- end::Download-->
                            </div>
                            <!-- end::Actions-->
                            <!-- begin::Action-->
                            <a href="{{ route('permission.create') }}" class="my-1 btn btn-primary">Add User Role Permission</a>
                            <!-- end::Action-->
                        </div>
                        <!-- end::Footer-->
                    </div>
