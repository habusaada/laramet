    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <!--begin::Form-->
                {{ html()->form('POST', route('permission.store'))->class(['form d-flex flex-column flex-lg-row'])->attributes(['files' => 'true', 'data-parsley-validate' => '', 'enctype' => 'multipart/form-data'])->open() }}
                    ...
                    <div class="py-4 card card-flush">
                        ...
                        <div class="card-header">
                            <div class="card-title">
                                <h2>User Role Permission Details</h2>
                            </div>
                        </div>
                        <!--end::Card header-->
                        <!--begin::Card body-->
                        <div class="pt-0 card-body">
                            ...
                            <div class="mb-10 fv-row">
                                <!--begin::Label-->
                                <label class="required form-label">User Role Permission</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                ...
                                <!--end::Input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">Enter the name of the role permission to be added.</div>
                                <!--end::Description-->
                                <!--begin::error-->
                                @if ($errors->has('name'))
                                    <ul>
