    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <!--begin::Form-->
                {{ html()->modelForm($data['permission'], 'PUT', route('permission.update', $data['permission']->id))->class(['form d-flex flex-column flex-lg-row'])->attributes(['files' => 'true', 'data-parsley-validate' => '', 'enctype' => 'multipart/form-data'])->open() }}
                        ...
                        <div class="pt-0 card-body">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <input type="text" name="name" class="mb-2 form-control form-control-solid" placeholder=""
                                    value="{{ $data['permission']->name }}" required />
                                <!--end::Input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">Enter the name of the role to be added.</div>
                                <!--end::Description-->
                                <!--begin::error-->
                                @if ($errors->has('name'))
                                    <ul>
