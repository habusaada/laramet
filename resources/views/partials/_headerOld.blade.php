...
<div id="kt_app_header" class="app-header">
    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <!--begin::Mobile logo-->
        <div class="d-flex align-items-center d-lg-none flex-grow-1 flex-lg-grow-0">
            <a href="{{ URL::to('/') }}">
                <img alt="Logo"
                    src="{{ url('template/demo1/assets/media/logos/horizontal-logo.svg') }}"
                    class="h-20px h-lg-35px app-sidebar-logo-default theme-light-show" />
                <img alt="Logo"
                    src="{{ url('template/demo1/assets/media/logos/horizontal-logo.svg') }}"
                    class="h-20px h-lg-35px app-sidebar-logo-default theme-dark-show" />
            </a>
        </div>
        <!--end::Mobile logo-->
        <!--begin::Header wrapper-->
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1 mx-lg-5"
            ...
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
                ...
                <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
                    ...
                    data-kt-swapper-parent="{default: '#kt_app_body', lg: '#kt_app_header_wrapper'}">
                    <!--begin::Menu-->
                    <div class="px-2 my-5 menu menu-rounded menu-column menu-lg-row my-lg-0 align-items-stretch fw-semibold fs-5 px-lg-0"
            ...
            <div class="flex-shrink-0 app-navbar">
                    ...
                    <div id="kt_header_search" class="header-search d-flex align-items-stretch"
                        ...
                        <div data-kt-search-element="content"
                            ...
                            <div data-kt-search-element="wrapper">
                                <!--begin::Form-->
                                <form data-kt-search-element="form" class="mb-3 w-100 position-relative"
                                    autocomplete="off">
                                    <!--begin::Icon-->
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen021.svg-->
                                    <span
                            ...
                            <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
                                ...
                                <div class="d-flex flex-column px-9">
                                    ...
                                    <div class="pt-10 pb-0">
                                        ...
                                        <!--end::Title-->
                                        <!--begin::Text-->
                                        <div class="pt-1 text-center text-gray-600 fw-semibold">Outlines keep you
                    ...
                    <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold fs-base w-150px"
                        ...
                        <div class="px-3 my-0 menu-item">
                            <a href="#" class="px-3 py-2 menu-link" data-kt-element="mode"
                                ...
                                <span class="menu-title">مظلم</span>
                            </a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                ...
                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px"
                        ...
                        <img src="{{ Auth::user()->getFirstMediaUrl('user_image') ?: url('template/demo1/assets/media/avatars/blank.png') }}"
                            alt="user" />
                    </div>
                    ...
                    <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold fs-6 w-275px"
                        ...
                        <div class="px-3 menu-item">
                            <div class="px-3 menu-content d-flex align-items-center">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo"
                                        src="{{ Auth::user()->getFirstMediaUrl('user_image') ?: url('template/demo1/assets/media/avatars/blank.png') }}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                                <div class="d-flex flex-column">
                                    <div class="mb-2 fw-bold d-flex align-items-center fs-5">
                                        {{ Auth::user()->name }}
                                        <span
                                            class="px-2 py-1 badge badge-light-success fw-bold fs-8 ms-2">{{ Auth::user()->getRoleNames()->first() }}</span>
                                    </div>
                                    <a href="#"
                        ...
                        <div class="px-5 menu-item">
                            <a href="../../demo1/account/overview.html" class="px-5 menu-link">الملف الشخصي</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="px-5 menu-item">
                            <a href="../../demo1/account/overview.html" class="px-5 menu-link">تغيير كلمة
                                المرور</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="px-5 menu-item">
                            <a href="../../demo1/account/overview.html" class="px-5 menu-link">النشاطات</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="px-5 menu-item">
                            <a href="../../demo1/account/overview.html" class="px-5 menu-link">المساعدة
                                والدعم</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="px-5 menu-item" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                            ...
                            <div class="py-4 menu-sub menu-sub-dropdown w-175px">
                                <!--begin::Menu item-->
                                <div class="px-3 menu-item">
                                    <a href="../../demo1/account/referrals.html"
                                        class="px-5 menu-link">Referrals</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="px-3 menu-item">
                                    <a href="../../demo1/account/billing.html"
                                        class="px-5 menu-link">Billing</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="px-3 menu-item">
                        ...
                        <div class="px-5 my-1 menu-item">
                            <a href="../../demo1/account/settings.html" class="px-5 menu-link"></a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="px-5 menu-item">
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button type="submit" class="px-5 btn menu-link w-100">تسجيل الخروج</button>
                            </form>
                        </div>
                        <!--end::Menu item-->
                    </div>
