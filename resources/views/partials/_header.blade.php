...
<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
    <!--begin::Header-->
    <div id="kt_app_header" class="bg-light app-header" data-kt-sticky="true" data-kt-sticky-activate="{default: true, lg: true}" data-kt-sticky-name="app-header-minimize" data-kt-sticky-offset="{default: '200px', lg: '0'}" data-kt-sticky-animation="false">
                                ...
                                <div class="overflow-hidden menu-state-bg menu-extended overflow-lg-visible" data-kt-menu-dismiss="true">
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="mb-3 col-lg-6">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        ...
                                                        <a href="index.html" class="menu-link">
                                                            <span class="flex-shrink-0 rounded menu-custom-icon d-flex flex-center w-40px h-40px me-3">
                                                ...
                                                <div class="mb-3 col-lg-6">
                                                    ...
                                                    <div class="p-0 m-0 menu-item">
                                                        ...
                                                        <a href="dashboards/online-courses.html" class="menu-link">
                                                            ...
                                                            <span class="d-flex flex-column">
                                                                <span class="text-gray-800 fs-6 fw-bold">Online Courses</span>
                                        ...
                                        <div class="px-3 py-3 menu-more bg-light col-lg-4 py-lg-6 px-lg-6 rounded-end">
                                            <!--begin:Heading-->
                                            <h4 class="mt-3 mb-3 text-gray-800 fs-6 fs-lg-4 fw-bold ms-4">More Dashboards</h4>
                                            <!--end:Heading-->
                                            <!--begin:Menu item-->
                                            <div class="p-0 m-0 menu-item">
                                                <!--begin:Menu link-->
                                    ...
                                    <div class="overflow-auto d-flex w-100">
                                        <ul class="p-0 nav nav-stretch nav-line-tabs fw-bold fs-6 p-lg-10 flex-nowrap flex-grow-1">
                                            ...
                                            <li class="nav-item mx-lg-1">
                                                <a class="py-3 nav-link py-lg-6 active text-active-primary" href="#" data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_pages">General</a>
                                            </li>
                                            <!--end:Nav item-->
                                            <!--begin:Nav item-->
                                            <li class="nav-item mx-lg-1">
                                                <a class="py-3 nav-link py-lg-6 text-active-primary" href="#" data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_account">Account</a>
                                            </li>
                                            <!--end:Nav item-->
                                            <!--begin:Nav item-->
                                            <li class="nav-item mx-lg-1">
                                                <a class="py-3 nav-link py-lg-6 text-active-primary" href="#" data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_authentication">Authentication</a>
                                            </li>
                                            <!--end:Nav item-->
                                            <!--begin:Nav item-->
                                            <li class="nav-item mx-lg-1">
                                                <a class="py-3 nav-link py-lg-6 text-active-primary" href="#" data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_utilities">Utilities</a>
                                            </li>
                                            <!--end:Nav item-->
                                            <!--begin:Nav item-->
                                            <li class="nav-item mx-lg-1">
                                                <a class="py-3 nav-link py-lg-6 text-active-primary" href="#" data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_widgets">Widgets</a>
                                            </li>
                                            <!--end:Nav item-->
                                        </ul>
                                    </div>
                                                ...
                                                <div class="col-lg-7">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-6 col-lg-4 mb-lg-0">
                                                            ...
                                                            <div class="mb-0">
                                                                <!--begin:Menu heading-->
                                                                <h4 class="mb-3 fs-6 fs-lg-4 fw-bold ms-4">General Modals</h4>
                                                                <!--end:Menu heading-->
                                                                <!--begin:Menu item-->
                                                                <div class="p-0 m-0 menu-item">
                                                                    <!--begin:Menu link-->
                                                        ...
                                                        <div class="mb-6 col-lg-4 mb-lg-0">
                                                            ...
                                                            <div class="mb-6">
                                                                <!--begin:Menu heading-->
                                                                <h4 class="mb-3 fs-6 fs-lg-4 fw-bold ms-4">Advanced Modals</h4>
                                                                <!--end:Menu heading-->
                                                                <!--begin:Menu item-->
                                                                <div class="p-0 m-0 menu-item">
                                                                    <!--begin:Menu link-->
                ...
                <div class="flex-shrink-0 app-navbar">
                                        ...
                                        <div class="scroll-y mh-200px mh-lg-350px">
                                            ...
                                            <a href="#" class="mb-5 text-gray-900 d-flex text-hover-primary align-items-center">
                                                ...
                                                <div class="symbol symbol-40px me-4">
                                                    <img src="{{ Auth::user()->getFirstMediaUrl('user_image') ?: url('template/demo1/assets/media/avatars/blank.png') }}" alt="" />
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Title-->
                                ...
                                <div class="py-5 card-body">
                                    ...
                                    <div class="mh-450px scroll-y me-n5 pe-5">
                                        ...
                                        <div class="row g-2">
                                            <!--begin::Col-->
                                            <div class="col-4">
                                                <a href="#" class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                                    <img src="assets/media/svg/brand-logos/amazon.svg" class="mb-2 w-25px h-25px" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                                    <img src="assets/media/svg/brand-logos/angular-icon-1.svg" class="mb-2 w-25px h-25px" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                                    <img src="assets/media/svg/brand-logos/atica.svg" class="mb-2 w-25px h-25px" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                                    <img src="assets/media/svg/brand-logos/beats-electronics.svg" class="mb-2 w-25px h-25px" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                                    <img src="assets/media/svg/brand-logos/codeigniter.svg" class="mb-2 w-25px h-25px" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                                    <img src="assets/media/svg/brand-logos/bootstrap-4.svg" class="mb-2 w-25px h-25px" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                                    <img src="assets/media/svg/brand-logos/google-tag-manager.svg" class="mb-2 w-25px h-25px" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                                    <img src="assets/media/svg/brand-logos/disqus.svg" class="mb-2 w-25px h-25px" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                                    <img src="assets/media/svg/brand-logos/dribbble-icon-1.svg" class="mb-2 w-25px h-25px" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                                    <img src="assets/media/svg/brand-logos/google-play-store.svg" class="mb-2 w-25px h-25px" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                                    <img src="assets/media/svg/brand-logos/google-podcasts.svg" class="mb-2 w-25px h-25px" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                                    <img src="assets/media/svg/brand-logos/figma-1.svg" class="mb-2 w-25px h-25px" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                                    <img src="assets/media/svg/brand-logos/github.svg" class="mb-2 w-25px h-25px" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                                    <img src="assets/media/svg/brand-logos/gitlab.svg" class="mb-2 w-25px h-25px" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                                    <img src="assets/media/svg/brand-logos/instagram-2-1.svg" class="mb-2 w-25px h-25px" alt="" />
                                            ...
                                            <div class="col-4">
                                                <a href="#" class="px-3 py-4 mb-3 text-center text-gray-800 rounded d-flex flex-column flex-center text-hover-primary bg-hover-light">
                                                    <img src="assets/media/svg/brand-logos/pinterest-p.svg" class="mb-2 w-25px h-25px" alt="" />
                    ...
                    <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-35px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                            <img src="{{ Auth::user()->getFirstMediaUrl('user_image') ?: url('template/demo1/assets/media/avatars/blank.png') }}" class="rounded-3" alt="user" />
                        </div>
                        ...
                        <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold fs-6 w-275px" data-kt-menu="true">
                            ...
                            <div class="px-3 menu-item">
                                <div class="px-3 menu-content d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo" src="{{ Auth::user()->getFirstMediaUrl('user_image') ?: url('template/demo1/assets/media/avatars/blank.png') }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
                                    <div class="d-flex flex-column">
                                        ...
                                        <span class="px-2 py-1 badge badge-light-success fw-bold fs-8 ms-2">{{ auth()->user()->getRoleNames()->first() }}</span>
                            ...
                            <div class="px-5 menu-item">
                                <a href="{{ route('user.show', Auth::user()->id) }}" class="px-5 menu-link">My Profile</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="px-5 menu-item">
                            ...
                            <div class="px-5 menu-item">
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button type="submit" class="px-5 btn menu-link w-100">Sign Out</button>
                                </form>
                            </div>
                            <!--end::Menu item-->
                        </div>
