...
!(function (e) {
  ...
  (t = {
      ...
      whenAll: function (i) {
          ...
          for (
              ...
              (r = c[a]) && e.isFunction(r.promise) ? r.promise().done(l(a, s, c)).fail(l(a, n, o)) : (u.notifyWith(this, r), --g);
      ...
      (i.prototype = {
                  ...
                  (i.fileManager = {
                      ...
                      getUploadStats: function (e, a, r) {
                          ...
                          return (
                              ...
                              (n = { fileId: e, started: s, elapsed: l, loaded: a, total: r, bps: o.bps, bitrate: i._getSize(o.bps, !1, i.bitRateUnits), pendingBytes: c }),
                      ...
                      exists: function (t) {
                          ...
                          return -1 !== e.inArray(t, a) && (!altId || -1 !== e.inArray(altId, a));
                      },
                      count: function () {
                  ...
                  (i = a.resumableManager = {
                      ...
                      setProcessed: function (t) {
                          ...
                          (i.completed = !0),
                              ...
                              "success" === t
                                  ...
                                  : "cancel" !== t &&
                                    (a.showPreview && (a._setThumbStatus(d, "Error"), a._setPreviewError(d, !0), a._setProgress(101, c, a.msgProgressError), a._setProgress(101, a.$progress, a.msgProgressError), (a.cancelling = !p)),
                                    a.$errorContainer.find('li[data-file-id="' + f.fileId + '"]').length ||
                                        ...
                                        p && (o.removeFile(l), delete i.chunksProcessed[l], o.isProcessed() && a._setProgress(101)))),
                      ...
                      processUpload: function () {
                          ...
                          return r.testUrl
                              ? ((n = new FormData()),
                                (s = o.stack[p]),
                                a._setUploadData(n, { fileId: p, fileName: s.fileName, fileSize: s.size, fileRelativePath: s.relativePath, chunkSize: i.chunkSize, chunkCount: i.chunkCount }),
                                (l = function (e) {
                                ...
                                void a._ajaxSubmit(l, d, u, c, n, p, i.fileIndex, r.testUrl))
                              ...
                              (v = new FormData()),
                                  ...
                                  (_ = function (t, d, c) {
                                      ...
                                      var f = a.uploadParamNames,
                                          ...
                                          m = [u, e, s, o, i, w];
                                      t.error
                                          ? (r.showErrorLog && a._log(n.retryStatus, { retry: s + 1, filename: i.fileName, chunk: e }), a._raise("filechunkerror", m), i.pushAjax(e, s + 1), (i.error = t.error), h(t.error))
                                          : ((i.logs[t[p]] = !0),
                                  ...
                                  (C = function (t, r, n) {
                                      return a._isAborted()
                                          ...
                                          : ((w = a._getOutData(v, t)), i.setAjaxError(t, r, n), a._raise("filechunkajaxerror", [u, e, s, o, i, w]), i.pushAjax(e, s + 1), void h(g.resumableRetryError, { n: s - 1 }));
                                  }),
                                  (x = function () {
          ...
          _initTemplateDefaults: function () {
              ...
              (i =
                  ...
                  (H = t.MODAL_ID + "Label"),
                  (u = '<div id="' + t.MODAL_ID + '" class="file-zoom-dialog modal fade" aria-labelledby="' + H + '" {tabIndexConfig}></div>'),
                  (f =
                  ...
                  (W = '<button type="button" class="kv-desc-hide" aria-label="Close">{closeIcon}</button>'),
                  (p = '<div class="progress">\n    <div class="{class}" role="progressbar" aria-valuenow="{percent}" aria-valuemin="0" aria-valuemax="100" style="width:{percent}%;">\n        {status}\n     </div>\n</div>{stats}'),
                  (Z = '<div class="text-primary file-upload-stats"><span class="pending-time">{pendingTime}</span> <span class="upload-speed">{uploadSpeed}</span></div>'),
                  ...
                  (N = '<button type="button" class="kv-file-rotate {rotateClass}" title="{rotateTitle}">{rotateIcon}</button>'),
                  ...
                  (y = '<div class="file-preview-frame {frameClass}" id="{previewId}" data-fileindex="{fileindex}" data-fileid="{fileid}" data-filename="{filename}" data-template="{template}" data-zoom="{zoomData}"'),
                  ...
                  (I = '<img src="{data}" class="file-preview-image kv-preview-data" title="{title}" alt="{alt}"' + B + ">\n"),
                  (A = '<iframe class="kv-preview-data file-preview-office" src="https://view.officeapps.live.com/op/embed.aspx?src={data}"' + B + "></iframe>"),
                  (z = '<iframe class="kv-preview-data file-preview-gdocs" src="https://docs.google.com/gview?url={data}&embedded=true"' + B + "></iframe>"),
                  (D = '<video class="kv-preview-data file-preview-video" controls' + B + '>\n<source src="{data}" type="{type}">\n' + t.DEFAULT_PREVIEW + "\n</video>\n"),
                  ...
                  V._isPdfRendered() && (M = V.pdfRendererTemplate.replace("{renderer}", V._encodeURI(V.pdfRendererUrl))),
                  (V.defaults = {
                      layoutTemplates: {
                          main1: i,
                          main2: a,
                      ...
                      previewContentTemplates: { generic: F, html: S, image: I, text: E, office: A, gdocs: z, video: D, audio: j, flash: $, object: U, pdf: M, other: R },
              ...
              (i.previewCache = {
                  ...
                  get: function (e, a) {
                      ...
                      return g && g.length
                          ? ((a = void 0 === a ? !0 : a),
                            ...
                            (r = m ? v(o, g, l, d, s, u, c) : v("generic", g, l, d, s, u, c, o).setTokens({ content: f.content[e] })),
                            f.tags.length && f.tags[e] && (r = t.replaceTags(r, f.tags[e])),
                            t.isEmpty(p) || t.isEmpty(p.frameAttr) || ((n = t.createElement(r)), n.find(".file-preview-initial").attr(p.frameAttr), (r = n.html()), n.remove()),
                            r)
                          : "";
                  },
                  clean: function (e) {
                  ...
                  footer: function (e, a, r) {
                      ...
                      return (
                          ...
                          (o = i._renderFileActions(s, !1, C, b, _, x, y, T, c, u, !0, h, v)),
          ...
          showUserError: function (e, t, i) {
              var a,
                  r = this;
              r.uploadInitiated &&
                  (t && t.fileId ? (i || r.$errorContainer.find('[data-file-id="' + t.fileId + '"]').remove(), (a = r.fileManager.getFileName(t.fileId)), a && (e = "<b>" + a + ":</b> " + e)) : i || r.$errorContainer.html(""),
          ...
          _setZoomContent: function (i, a) {
              var r,
                  ...
                  y = i.data("zoom");
              y && ((y = decodeURIComponent(y)), (m = w.html().replace(h.zoomPlaceholder, "").setTokens({ zoomData: y })), w.html(m), i.data("zoom", ""), w.attr("data-zoom", y)),
          ...
          _showModal: function (e) {
              ...
              e &&
                  ...
                  i.length && ((a = i.css("transform")), a && o.find(".file-zoom-detail").css("transform", a)),
              ...
              if ((d.reversePreviewOrder && (t = "prev" === t ? "next" : "prev"), !u.attr("disabled"))) {
                  ...
                  0 > o ||
                      ...
                      a.length && a.hasClass("rotatable")
                          ? ((s = a.data("angle") || 0), c.addClass("rotatable").data("angle", s), (l = a.find(".kv-file-content > :first-child")), d._initRotateZoom(a, l))
          ...
          _refreshPreview: function () {
              ...
              (i._inputFileCount() || i.isAjaxUpload) &&
                  i.showPreview &&
                  i.isPreviewable &&
                  (i.isAjaxUpload && i.fileManager.count() > 0 ? ((t = e.extend(!0, [], i.getFileList())), i.fileManager.clear(), i._clearFileInput()) : (t = i.$element[0].files), t && t.length && i.readFiles(t));
          },
          ...
          _initUploadSuccess: function (i, a, r) {
              ...
              return !g.showPreview || "object" != typeof i || e.isEmptyObject(i)
                  ...
                  : (void 0 !== i.initialPreview &&
                        ...
                        d.length > 0 && !t.isArray(d) && (d = d.split(g.initialPreviewDelimiter)),
                        d.length && (g._mergeArray("initialPreview", d), g._mergeArray("initialPreviewConfig", c), g._mergeArray("initialPreviewThumbTags", u)),
                        void 0 !== a
                            ? r
                                ? ((f = a.attr("id")), (p = g._getUploadCacheIndex(f)), null !== p && (g.uploadCache[p] = { id: f, content: d[0], config: c[0] || [], tags: u[0] || [], append: n }))
                            ...
                            : (g.previewCache.set(d, c, u, n), g._initPreview(), g._initPreviewActions())),
                    void g._resetCaption());
          },
          ...
          _uploadSingle: function (i, a, r, n) {
              ...
              b.enableResumableUpload ||
                  ((b.uploadInitiated = !0),
                  b.showPreview && ((s = _.getThumb(a)), (f = s.find(".file-thumb-progress")), (d = s.find(".kv-file-upload")), (c = s.find(".kv-file-remove")), f.show()),
                  0 === C ||
                      !T ||
                          ...
                          b.fileBatchCompleted &&
                              setTimeout(function () {
                                  ...
                                  b._updateInitialPreview(),
                                      ...
                                      b.uploadAsync && e.length && (t.addCss(e, t.SORT_CSS), b._initSortable()),
                                      b._raise("filebatchuploadcomplete", [_.stack, b._getExtraData()]),
                      ...
                      (p = function (n) {
                          (o = b._getOutData(x, n)),
                              ...
                              r || (b.ajaxAborted = !1),
                              b.showPreview && (s.hasClass("file-preview-success") || (b._setThumbStatus(s, "Loading"), t.addCss(s, "file-uploading")), d.attr("disabled", !0), c.attr("disabled", !0)),
                              r || b.lock(),
                              -1 !== _.errors.indexOf(a) && delete _.errors[a],
                              b._raise("filepreupload", [o, y, i, b._getThumbFileId(s)]),
                              e.extend(!0, F, o),
                              b._abort(F) && (n.abort(), r || (b._setThumbStatus(s, "New"), s.removeClass("file-uploading"), d.removeAttr("disabled"), c.removeAttr("disabled")), b._setProgressCancelled());
                      }),
                      (m = function (n, l, c) {
                          ...
                          (o = b._getOutData(x, c, n)),
                              ...
                              setTimeout(function () {
                                  t.isEmpty(n) || t.isEmpty(n.error)
                                      ? (b.showPreview && (b._setThumbStatus(s, "Success"), d.hide(), b._initUploadSuccess(n, s, r), b._setProgress(101, f)),
                                        b._raise("fileuploaded", [o, p, i, b._getThumbFileId(s)]),
                                        r ? (w(), I()) : b.fileManager.remove(s))
                                      : ((u = !0),
                                        (g = b._parseError(P, c, b.msgUploadError, b.fileManager.getFileName(a))),
                          ...
                          (g = b._parseError(P, t, n, b.fileManager.getFileName(a))),
                              ...
                              setTimeout(function () {
                                  ...
                                  r && (w(), E()),
                                      ...
                                      b._setProgress(101, b.$progress, b.msgAjaxProgressError.replace("{operation}", P)),
                                      (i = b.showPreview && s ? s.find(".file-thumb-progress") : ""),
                      ...
                      (r = function (t, i, a) {
                          ...
                          (o = l._parseError(g, t, a)),
                              ...
                              l.showPreview &&
                                  ...
                                  l._setProgress(101, l.$progress, l.msgAjaxProgressError.replace("{operation}", g)));
                      });
                  var m = 0;
              ...
              if (t.length && !e.hasClass("hide-rotate")) {
                  switch (
                      ...
                      case 270:
                          var p = 100 * u,
                              g = 100 - p;
                          c = 1 === u ? " translateX(-100%)" : " translate(-" + p + "%, " + g + "%) scale(" + u + ")";
                  }
                  t.addClass("rotate-animate").css("transform", a + c),
                      setTimeout(function () {
                          t.removeClass("rotate-animate").css("transform", r + c), e.data("angle", n);
                      }, d.fadeDelay);
              }
          },
          ...
          _initRotateZoom: function (e, t) {
              ...
              r.length &&
                  ...
                  a.hasClass("rotatable") &&
                      ...
                      r.on("click", function () {
                          (n = (a.data("angle") || 0) + 90), i._handleRotation(a, a.find(".file-zoom-detail"), n), i._handleRotation(e, t, n), e.hasClass("hide-rotate") && e.data("angle", n);
                      })));
          },
                  ...
                  a.find(n).each(function () {
                      ...
                      if (!t.isEmpty(f) && void 0 !== p) {
                          ...
                          (x = parseInt(x.replace(t.INIT_FLAG, ""))),
                              ...
                              (m = e.extend(!0, {}, { url: i._encodeURI(f), type: "POST", dataType: "json", data: e.extend(!0, {}, { key: p }, b) }, i._ajaxDeleteSettings)),
          ...
          _getSize: function (t, i, a) {
              ...
              if ("function" == typeof c) r = c(s);
                  ...
                  (n = u.toFixed(2)), n == u && (n = u), console.log("size ", s), (r = n + " " + a[l]);
              }
          ...
          _generatePreviewTemplate: function (i, a, r, n, o, s, l, d, c, u, f, p, g, m, h) {
              ...
              return (
                  (w = 400 > F ? x.previewSettingsSmall[j] || x.defaults.previewSettingsSmall[j] : x.previewSettings[j] || x.defaults.previewSettings[j]),
                  w &&
                  ...
                  (b = function (a, l, d, c, f) {
                      ...
                      return (
                          ...
                          t.isEmpty(m) || (void 0 !== m.title && null !== m.title && (S = m.title), void 0 !== m.alt && null !== m.alt && (I = S = m.alt)),
                          (h = {
                              previewId: v,
                              caption: y,
                              title: S,
                  ...
                  (C = x.fileActionSettings.showRotate && -1 !== e.inArray($, x.rotatableFileExtensions)),
                  x.fileActionSettings.showZoom && ((_ = "kv-zoom-thumb"), C && (_ += " rotatable" + (D ? " hide-rotate" : "")), (T = b(D ? "other" : i, a, !0, _, h))),
                  (T = "\n" + x._getLayoutTemplate("zoomCache").replace("{zoomContent}", T)),
                  "function" == typeof x.sanitizeZoomCache && (T = x.sanitizeZoomCache(T)),
                  (_ = "kv-preview-thumb"),
                  C && (_ += " rotatable" + (z || x.hideThumbnailContent ? " hide-rotate" : "")),
          ...
          _updateFileDetails: function (e) {
              ...
              !d && s.fileManager.count() > 0 ? ((o = s.fileManager.getFirstFile()), console.log("KV SAYS", o), (i = o.nameFmt)) : (i = d ? s.slug(d) : "_"),
          ...
          _isValidSize: function (e, i, a, r, n, o) {
              ...
              return t.isEmpty(f) || !a.length
                  ? !0
                  : ((d = a[0]),
                    (l = "Width" === i ? d.naturalWidth || d.width : d.naturalHeight || d.height),
                    ("Small" === e ? l >= f : f >= l)
                        ? !0
                        : ((s = c["msgImage" + i + e] || 'Image "{name}" has a size validation error (limit "{size}").'),
                          c._showFileError(s.setTokens({ name: n, size: f, dimension: l }), o),
              ...
              (c && u) ||
                  ...
                  i.off(l).on(l, function () {
                      ...
                      var e = i[0],
                          ...
                          u = e.offsetWidth,
                          g = t.getRotation(r);
                      if ((f && (n.find(".kv-file-content").css("visibility", "visible"), d.$preview.addClass("hide-content")), i.data("orientation", r), l && a.data("orientation", r), 5 > r))
          ...
          _validateImageOrientation: function (i, a, r, n, o, s, l, d) {
              ...
              return (
                  (p = f._getExifObj(d)),
                  f.canOrientImage
                      ? (i.css("image-orientation", g ? "from-image" : "none"), void f._validateImage(r, n, o, s, l, d, p))
                      : ((u = t.getZoomSelector(r, " img")),
                        (c = p ? p["0th"][piexif.ImageIFD.Orientation] : null)
                            ? (f.setImageOrientation(i, e(u), c, f._getFrame(r)), f._raise("fileimageoriented", { $img: i, file: a }), void f._validateImage(r, n, o, s, l, d, p))
                          ...
                          g.data("validated") ||
                              ...
                              setTimeout(function () {
                                  ...
                                  (l = c._isValidSize("Small", "Width", g, f, i, s)),
                                      ...
                                      c.resizeImage || ((l = l && c._isValidSize("Large", "Width", g, f, i, s)), (d = d && c._isValidSize("Large", "Height", g, f, i, s))),
                                      c._raise("fileimageloaded", [e]),
                                      f.data("exif", o),
                                      l && d && (c.fileManager.addImage(t, { ind: p, img: g, thumb: f, pid: e, typ: a, siz: r, validated: !1, imgData: n, exifObj: o }), c._validateAllImages());
                              }, c.processDelay));
                      })
                      .one("error", function () {
          ...
          _getResizedImage: function (i, a, r, n) {
              ...
              if (
                  ...
                  (m = [i, F, S]),
                  (!p || !y || (C >= w && x >= b)) && (y && p && h._raise("fileimageresized", m), r.val++, r.val === n && h._raise("fileimagesresized"), !y))
              )
              ...
              try {
                  P.drawImage(v, 0, 0, w, b),
                      ...
                      E && ((f = window.piexif.dump(E)), (d = window.piexif.insert(f, d))),
                      (o = t.dataURI2Blob(d)),
          ...
          _renderFileFooter: function (e, i, a, r, n) {
              ...
              return (
                  (a = l._getSize(a)),
                  (s = { type: e, caption: i, size: a, width: r, progress: "", indicator: b }),
                  l.isAjaxUpload ? ((s.progress = l._renderThumbProgress()), (s.actions = l._renderFileActions(s, f, !1, c, p, g, u, !1, !1, !1))) : (s.actions = l._renderFileActions(s, !1, !1, !1, !1, g, u, !1, !1, !1)),
                  (o = m.setTokens(s)),
          ...
          _renderFileActions: function (e, t, i, a, r, n, o, s, l, d, c, u, f) {
              ...
              return (
                  a && (_ = p._getLayoutTemplate("actionDelete").setTokens({ removeClass: k, removeIcon: T.removeIcon, removeTitle: T.removeTitle, dataUrl: m, dataKey: b, key: d })),
                  r && (w = p._getLayoutTemplate("actionRotate").setTokens({ rotateClass: T.rotateClass, rotateIcon: T.rotateIcon, rotateTitle: T.rotateTitle })),
                  t && (C = p._getLayoutTemplate("actionUpload").setTokens({ uploadClass: T.uploadClass, uploadIcon: T.uploadIcon, uploadTitle: T.uploadTitle })),
                  i &&
                      ((x = p._getLayoutTemplate("actionDownload").setTokens({ downloadClass: T.downloadClass, downloadIcon: T.downloadIcon, downloadTitle: T.downloadTitle, downloadUrl: u || p.initialPreviewDownloadUrl })),
                      (x = x.setTokens({ filename: f, key: d }))),
                  n && (h = p._getLayoutTemplate("actionZoom").setTokens({ zoomClass: T.zoomClass, zoomIcon: T.zoomIcon, zoomTitle: T.zoomTitle })),
                  o && c && ((g = "drag-handle-init " + T.dragClass), (v = p._getLayoutTemplate("actionDrag").setTokens({ dragClass: g, dragTitle: T.dragTitle, dragIcon: T.dragIcon }))),
          ...
          _canPreview: function (e) {
              ...
              return (
                  ...
                  (o = (g && -1 !== g.indexOf(c)) || (m && -1 !== m.indexOf(l)) || (h.length && t.compare(s, b)) || (v && !isNaN(v) && d > v)),
                  !o && (a || r || n)
              );
          },
              ...
              a.length
                  ? a
                        ...
                        .on("focusin.fileinput", function () {
                            setTimeout(function () {
                                i.val() || (t._toggleLoading("hide"), t._setFileDropZoneTitle()), a.off(r);
                            }, 2500);
                        })
              ...
              var a,
                  ...
                  v = function (t, n, o, s, l) {
                      ...
                      r._previewDefault(n, !0),
                          ...
                          (r.isError = r.isAjaxUpload ? r._showFileError(t, c) : r._showError(t, f)),
                      ...
                      if (
                          ...
                          (M = function () {
                              var e = !!C.loadedImages[x],
                                  t = d.setTokens({ index: w + 1, files: u, percent: 50, name: A });
                              setTimeout(function () {
                                  ...
                                  r._raise("fileloaded", [B, y, x, w, n]) && r.isAjaxUpload ? e || C.add(B) : e && C.removeFile(x);
                          }),
                          B)
                      ) {
                          ...
                          if ((t.isEmpty(m) || (H = new RegExp("\\.(" + m.join("|") + ")$", "i")), (r.isAjaxUpload && C.exists(D)) || r._getFrame(y, !0).length)) {
                              ...
                              return (
                                  ...
                                  void (r.isAjaxUpload
                                      ? (r.stackIsUpdating || (r.duplicateErrors.push(k), (r.isDuplicateError = !0), r._raise("fileduplicateerror", [B, D, A, L, y, w])), a(w + 1), r._updateFileDetails(u))
                                      : (r._showError(k, G), r.unlock(), (u = 0), r._clearFileInput(), r.reset(), r._updateFileDetails(u)))
                              );
                          }
                          if (r.maxFileSize > 0 && Z > r.maxFileSize) return (k = r.msgSizeTooLarge.setTokens({ name: A, size: L, maxSize: r._getSize(r.maxFileSize * r.bytesToKB, !0) })), void v(k, B, y, w, D);
                          if (null !== r.minFileSize && Z <= t.getNum(r.minFileSize)) return (k = r.msgSizeTooSmall.setTokens({ name: A, size: L, minSize: r._getSize(r.minFileSize * r.bytesToKB, !0) })), void v(k, B, y, w, D);
                          if (!t.isEmpty(p) && t.isArray(p)) {
                              for (P = 0; P < p.length; P += 1) (S = p[P]), ($ = f[S]), (W += $ && "function" == typeof $ && $(B.type, t.getFileName(B)) ? 1 : 0);
                              if (0 === W) return (k = r.msgInvalidFileType.setTokens({ name: A, types: V })), void v(k, B, y, w, D);
                          }
                          if (0 === W && !t.isEmpty(m) && t.isArray(m) && !t.isEmpty(H) && ((F = t.compare(A, H)), (W += t.isEmpty(F) ? 0 : F.length), 0 === W))
                              return (k = r.msgInvalidFileExtension.setTokens({ name: A, extensions: h })), void v(k, B, y, w, D);
                          if (!r._canPreview(B))
                              return (
                                  (j = r._raise("filebeforeload", [B, w, n])),
                                  r.isAjaxUpload && j && C.add(B),
                                  r.showPreview && j && (o.addClass("file-thumb-loading"), r._initCapStatus("processing"), r._previewDefault(B), r._initFileActions()),
                          ...
                          (U = N(B.type, A)),
                              ...
                              (n.onload = function (i) {
                                  var a,
                                      ...
                                      g = [],
                                      m = function (e, d) {
                                          if ((t.isEmpty(e) && ((u = t.arrayBuffer2String(n.result)), (e = t.isSvg(u) ? "image/svg+xml" : t.getMimeType(a, u, B.type))), (l = { name: A, type: e || "" }), d && "undefined" != typeof File))
                                              try {
                                          ...
                                          if ((U = N(e, ""))) {
                                              ...
                                              return (
                                                  ...
                                                  (p.onload = function (e) {
                                                      return r.isAjaxUpload && !r._raise("filebeforeload", [B, w, n])
                                                          ? ((q = !0), r._resetCaption(), n.abort(), s.html(""), o.removeClass("file-thumb-loading"), r._initCapStatus("valid"), void r.enable())
                                                          : (r._previewFile(w, B, e, z, l), r._initFileActions(), void M());
                                                  }),
                                          ...
                                          return r.isAjaxUpload && !r._raise("filebeforeload", [B, w, n])
                                              ? ((q = !0), r._resetCaption(), n.abort(), s.html(""), o.removeClass("file-thumb-loading"), r._initCapStatus("valid"), void r.enable())
                                              : (r._previewFile(w, B, i, z, l), r._initFileActions(), void M());
                                      };
                                  if (
                                      ((p = B.type),
                                      (l = { name: A, type: p }),
                              ...
                              (n.onprogress = function (e) {
                                  if (e.lengthComputable) {
                                      var t = (e.loaded / e.total) * 100,
                                          i = Math.ceil(t);
                                      (k = d.setTokens({ index: w + 1, files: u, percent: i, name: A })),
                                          setTimeout(function () {
                                              q || s.html(k);
                                          }, r.processDelay);
                                  }
          ...
          cancel: function () {
              ...
              if (
                  (i.enableResumableUpload && o
                      ...
                      : (i.ajaxPool && i.ajaxPool.cancel(), i._raise("fileuploadcancelled", [i.fileManager])),
                  i._initAjax(),
                  s > 0)
              )
              ...
              switch (
                  ...
                  this.each(function () {
                      ...
                      l ||
                          ...
                          "en" === p || t.isEmpty(e.fn.fileinputLocales[p]) || (u = e.fn.fileinputLocales[p] || {}),
                          (o = e.extend(!0, {}, e.fn.fileinput.defaults, f, e.fn.fileinputLocales.en, u, d, s.data())),
                          (l = new i(this, o)),
                          s.data("fileinput", l)),
  ...
  (e.fn.fileinput.defaults = {
      ...
      previewZoomButtonClasses: { prev: "btn btn-default btn-outline-secondary btn-navigate", next: "btn btn-default btn-outline-secondary btn-navigate", rotate: r, toggleheader: r, fullscreen: r, borderless: r, close: r },
      previewTemplates: {},
      ...
      (e.fn.fileinputLocales.en = {
          ...
          msgPaused: "Paused",
          msgPlaceholder: "ارفق الصورة البارزة",
          ...
          dropZoneTitle: "اسحب الملفات وافلتها هنا &hellip;",
